      ...
      child: SingleChildScrollView(
        child: Column(
          children: [
            ...
            if (index == 3) _Step4SkillsLocations(controller),
...
/// --- STEP 4 (Skills + Location) ---
class _Step4SkillsLocations extends StatelessWidget {
  final JobPostController c;
  _Step4SkillsLocations(this.c);
      ...
      children: [
        ...
        GlassContainer(
          ...
          child: Obx(
            () => DropdownButtonHideUnderline(
              child: DropdownButton<String>(
                value: c.jobLocationType.value,
                items: ['Remote', 'Onsite']
                    .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                    .toList(),
                onChanged: (v) {
                  c.jobLocationType.value = v!;
                  if (v == 'Remote') c.selectedCountry.value = '';
                },
              ),
            ),
          ),
        ...
        // Country Picker
        Obx(
          () => c.jobLocationType.value == 'Onsite'
              ? GlassContainer(
                  ...
                  child: InkWell(
                    onTap: () {
                      showCountryPicker(
                        ...
                        showPhoneCode: false,
                        onSelect: (country) {
                          c.selectedCountry.value = country.name;
                        },
                      );
                    },
                    child: Container(
                      ...
                      child: Obx(
                        () => Text(
                          c.selectedCountry.value.isEmpty
                              ? "Choose country"
