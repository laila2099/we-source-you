...
// class MediaLogosView extends GetView<HomeController> {
//   const MediaLogosView({Key? key}) : super(key: key);
...
// //                 runSpacing: 40.0,
// //                 children: List.generate(c.logoAssets.length, (index) {
// //                   // Calculate the delay for this logo (normalized to 0.0 - 1.0)
// //                   double begin =
// //                       c.randomDelays[index] /
// //                       (c.animationDuration.inMilliseconds);
// //                   double end =
...
// //                   // Cap the end interval at 1.0
// //                   if (end > 1.0) end = 1.0;

// //                   // Create the interval for the staggered animation
...
// //                   // Animation value based on the controller's progress and the calculated interval
...
// //                     end: 1.0,
// //                   ).evaluate(curvedAnimation);
// //                   // Animate a slight lift/scale from 0.8 to 1.0 (optional visual effect)
// //                   final scale = Tween<double>(
// //                     begin: 0.8,
// //                     end: 1.0,
// //                   ).evaluate(curvedAnimation);
...
// //                       child: _MediaLogo(
// //                         assetPath: c.logoAssets[index],
// //                         // Use index for a unique key to manage hover state
// //                         key: ValueKey(index),
// //                       ),
// //                     ),
// //                   );
...
// // 3. Hover Effect Widget (_MediaLogo)
...
//         onTap: () {
//           print("Clicked ${widget.assetPath}");
//         },
...
//           //   width: 200.w,
//           //   height: 100.h,
//           //   color: _isHovering ? Colors.black54 : null, // hover tint
//           // ),
//           child: SizedBox(
// width: 150,
// height: 100,
